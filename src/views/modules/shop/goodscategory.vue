  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('shop:goodscategory:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.catTwoId)">修改</el-button>
          <el-button type="text" size="small" @click="deleteHandle(scope.row.catTwoId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
