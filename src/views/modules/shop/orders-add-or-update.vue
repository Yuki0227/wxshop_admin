<template>
  <el-dialog
    ...
    <el-form-item label="订单状态" prop="orderState">
      <el-input v-model="dataForm.orderState" placeholder="订单状态：0->待付款；1->待发货；2->已发货；3->已完成；4->已关闭；5->无效订单"></el-input>
    </el-form-item>
    <el-form-item label="支付方式" prop="payWay">
      <el-input v-model="dataForm.payWay" placeholder="支付方式"></el-input>
    </el-form-item>
    ...
    <el-form-item label="用户电话" prop="userTel">
      <el-input v-model="dataForm.userTel" placeholder="用户电话"></el-input>
    </el-form-item>
