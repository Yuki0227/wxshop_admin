  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="类别id" prop="catId">
        <el-input v-model="dataForm.catId" placeholder="类别id"></el-input>
      </el-form-item>
      ...
      <el-form-item label="商品状态" prop="goodsState">
        <el-input v-model="dataForm.goodsState" placeholder="商品状态"></el-input>
      </el-form-item>
      ...
      <el-form-item label="三级类别" prop="catThreeId">
        <el-input v-model="dataForm.catThreeId" placeholder="三级类别"></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        hotNumber: [
          {required: true, message: '热门数不能为空', trigger: 'blur'}
        ],
        goodsState: [
      ...
      this.$nextTick(() => {
        ...
        if (this.dataForm.goodsId) {
          this.$http({
            ...
            if (data && data.code === 0) {
              this.dataForm.catId = data.goods.catId
              ...
              this.dataForm.catThreeId = data.goods.catThreeId
        ...
        if (valid) {
          this.$http({
            ...
            data: this.$http.adornData({
              ...
              'catThreeId': this.dataForm.catThreeId,
